    ...
    <div className="min-h-screen bg-white">
      <main>
        ...
        <section className="relative py-20 md:py-28 overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 text-center max-w-3xl">
            <h3 className="text-3xl md:text-4xl font-bold text-white mb-6">Parlons de vos besoins</h3>
            <p className="text-white/90 mb-8">Contactez-nous pour discuter de vos volumes, conditionnements et délais.</p>
            <Link to="/contact">
              <Button className="px-8 py-4 bg-[#FF6600] text-white rounded-xl font-bold shadow hover:brightness-110">
                Contactez-nous
              </Button>
